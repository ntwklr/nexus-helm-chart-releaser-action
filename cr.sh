...
Usage: $(basename "$0") <options>
    ...
    -u, --charts-repo-url   The Repository URL to the charts repo (example: https://example.com/repository/repo/)
...
release_charts() {
    ...
    do 
        curl -is -u "$auth" "$charts_repo_url" --upload-file "$tgz" | indent
    done
}
